...
{
    // https://medium.com/@erdemcanturk87/asp-net-core-render-partial-view-to-string-outside-controller-context-bc3db9a68fc8
        ...
        public static async Task<string> RenderViewToStringAsync<TModel>(this Controller controller, string viewNamePath, TModel model)
        {
            ...
            using (StringWriter writer = new StringWriter())
            {
                try
                {
                    ...
                    IOptions<HtmlMinificationOptions> minifierOpts = controller.HttpContext.RequestServices.GetService<IOptions<HtmlMinificationOptions>>();
                    ...
                    return writer.GetStringBuilder().ToString().MinimizeHTML(minifierOpts.Value.MinificationSettings);
                }
                catch (Exception exc)
                {
